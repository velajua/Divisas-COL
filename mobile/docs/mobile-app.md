...
website. It targets Expo SDK 54 and is intended for iOS and Android app-store
distribution.

Expo Go can run the app shell, but it does not include the
`react-native-google-mobile-ads` native module. Ads are skipped in Expo Go. To
test AdMob rendering, install a development or preview build generated by EAS.
