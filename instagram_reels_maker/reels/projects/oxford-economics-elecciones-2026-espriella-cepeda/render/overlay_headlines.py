...
SCENES = [
    ("raw_001_hook.png", "001_hook.png", "RIESGO ELECTORAL", "OXFORD PONE NUMEROS"),
    ("raw_002_base.png", "002_base.png", "ESCENARIO BASE", "PIB 3,5%"),
    ("raw_003_continuidad.png", "003_continuidad.png", "SI HAY CONTINUIDAD", "MAS PRESION"),
    ("raw_004_inflacion_tasas.png", "004_inflacion_tasas.png", "CONSUMO VS PRECIOS", "INFLACION 6,3%"),
    ("raw_005_bonos.png", "005_bonos.png", "BONOS A 10 ANOS", "9,5% VS 12,5%"),
    ("raw_006_fiscal.png", "006_fiscal.png", "ALERTA FISCAL", "DEUDA 64% DEL PIB"),
]
...
def add_gradient(base: Image.Image) -> Image.Image:
    ...
    for y in range(H):
        ...
        bottom_alpha = max(0, int(220 * ((y - 1240) / (H - 1240)))) if y > 1240 else 0
...
def add_headline(img: Image.Image, line1: str, line2: str) -> Image.Image:
    ...
    box_h = 194
    draw.rounded_rectangle((x - 18, y - 18, x - 18 + box_w, y - 18 + box_h), radius=14, fill=(0, 0, 0, 170))
